        ...
        <div className="max-w-2xl mx-auto w-full px-4 py-8 font-sans text-[#333]">
            ...
            >
                ...
                <div className="p-6 md:p-10 bg-white relative">
                     ...
                     <div className="bg-gradient-to-br from-[#1F3D2B] via-[#1a3328] to-[#0f1f16] text-white p-6 rounded-xl text-center mb-8 shadow-lg shadow-[#1F3D2B]/20 relative overflow-hidden group">
