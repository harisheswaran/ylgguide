...
export default function PackageBookingForm({ packageId, packageTitle, packagePrice, packageDescription }) {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            console.log('🚀 Submitting package booking to:', `${apiUrl}/api/bookings`);
    ...
    return (
        <div className="booking-form-container">
            ...
            <style jsx>{`
                ...
                input, select, textarea { padding: 12px 16px; border: 1px solid #E9ECEF; border-radius: 8px; font-size: 16px; }
                .package-info { background: #F8F9FA; padding: 20px; border-radius: 8px; border-left: 4px solid #C9A961; }
                .package-name { font-size: 18px; font-weight: 600; color: #1A4D2E; margin-bottom: 8px; }
                .package-description { font-size: 14px; color: #6C757D; }
