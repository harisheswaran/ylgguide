                ...
                <div className="bg-white/80 backdrop-blur-xl rounded-3xl shadow-2xl p-8 space-y-8 border border-white/50">
                    ...
                    <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
                        ...
                        <div className="text-center">
                            <p className="text-sm text-gray-600">
                                ...
                                <Link href="/signin" className="font-bold text-forest-600 hover:text-forest-500 transition-colors">
                                    Sign in
                                </Link>
                            </p>
                        </div>
                    ...
                    < div className="grid grid-cols-1 gap-3" >
                        <button
                            onClick={() => login()}
                            type="button"
                            className="w-full inline-flex justify-center items-center gap-3 py-2 px-4 border border-gray-300 rounded-lg shadow-sm bg-white text-sm font-medium text-gray-500 hover:bg-gray-50 transition-colors"
                        >
