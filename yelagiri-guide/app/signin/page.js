                    ...
                    <form className="space-y-6" onSubmit={handleSubmit}>
                        ...
                        <div className="flex items-center justify-between">
                            ...
                            <div className="text-sm">
                                <a href="#" className="font-medium text-white/90 hover:text-white transition-colors">
                                    Forgot password?
                                </a>
                            </div>
                        </div>
                        ...
                        <div className="text-center">
                            <p className="text-sm text-white/70">
                                ...
                                <Link href="/signup" className="font-bold text-white hover:underline transition-colors">
                                    Sign up
                                </Link>
                            </p>
                        </div>
...
export default function SignInPage() {
    return (
        <Suspense fallback={<div className="min-h-screen bg-black/80 flex items-center justify-center"><div className="w-8 h-8 border-2 border-white/30 border-t-white rounded-full animate-spin" /></div>}>
            <SignInContent />
        </Suspense>
    );
}
